...
pub fn trans_crate(krate: ast::Crate,
    ...
    if shared_ccx.sess().targeting_pnacl() {
        reachable.push("PPP_InitializeModule".to_string());
        reachable.push("PPP_GetInterface".to_string());
        reachable.push("PPP_ShutdownModule".to_string());
    }
